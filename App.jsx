...
*/
	...
	const enemyComponents = enemiesData.map(singleEnemy => (
		<Enemy
			key={singleEnemy.id} // make sure to provide a unique key
			currentImage={singleEnemy.currentImage}
			position={singleEnemy.position}
			orientation={singleEnemy.orientation}
		/>
	))
